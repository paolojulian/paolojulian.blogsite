...
const H1: FunctionComponent<React.HtmlHTMLAttributes<HTMLHeadingElement>> = ({
  ...
  return (
    <h1
      className={classNames('text-slate-800 font-bold text-6xl', className)}
      {...props}
    ></h1>
  );
};
  ...
  return (
    <h2
      className={classNames(
        'text-slate-800 font-bold text-2xl md:text-4xl pt-24 -mt-12',
        className
      )}
      {...props}
    ></h2>
...
const H3: FunctionComponent<React.HtmlHTMLAttributes<HTMLHeadingElement>> = ({
  ...
  return (
    <h3
      className={classNames(
        'text-slate-800 font-bold text-xl md:text-2xl mt-6',
        className
      )}
      {...props}
    ></h3>
