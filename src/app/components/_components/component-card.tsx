  ...
  return (
    <Link href={href} role='button'>
      <Stack
        ...
        role='button'
      >
        <div className='lg:aspect-[12/7] bg-neutral-200 mb-2 flex justify-center items-center relative'>
          <div className='absolute bottom-0 left-0 right-0 h-1/2 bg-gradient-to-t from-neutral-300 to-transparent z-10'></div>
