...
import SectionHeading from '@/app/(main-layout)/portfolio/_components/common/section-heading';
import ProjectItem from '@/app/(main-layout)/portfolio/_components/common/project-item';
